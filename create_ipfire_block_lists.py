...
list1_out.append('!  description: personal filters for ublock')
list1_out.append('!  expires: 1 day')
list1_out.append('!  homepage: https://raw.githubusercontent.com/mipiticuenta/ublock_live/main/unified_block_list')
list1_out.append('!  title: unified block list')
list1_out.append('! #============================================================================================')
list1_out.append('! *$image,redirect-rule=1x1.gif')
list1_out.append('! *$popup,3p ! impedes ctrl&click open in another tab')
list1_out.append('! attribute css selector : ##[]')
