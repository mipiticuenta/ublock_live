...
print(
    ...
    '# output: <temp0> textfile, sorted, deduplicated',               '\n',
    '# ============================================================', '\n',
    )
...
list3 = [line for line in list3 if not(re.search(r'^(com|net|org|[a-z]{2})\.(com|net|org|[a-z]{2})$', line))]           # <remove ^(com|net|org)\.[a-z]{2}$ root domains />
