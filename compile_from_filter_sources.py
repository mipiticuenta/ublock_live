...
print(' 8/20 : remove redundant .domain$domain=domain ')
list2 = (
...
print(' 9/20 : split urls with $ domain= ')
...
print('10/20 : remove domain= denyallow= filters and keep the related domains')
...
print('11/20 : split , separated domains ')
...
while n_1 > len(list2):                                                              # <recursive loops up to no further length reduction for list2 />
    ...
    print('14/20 : split domains with urls ')
...
list2 = [re.sub(r'^[_\W]?ext[_\W]?\*?$', '', line) for line in list2]                # <remove spurious ext filter />
...
list2 = [re.sub(r'^[_\W]?jquery[_\W]?\*?$', '', line) for line in list2]             # <remove spurious jquery filter />
