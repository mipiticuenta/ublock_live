...
list2 = [re.sub(r'^[_\W]?accuweather[_\W]*$', '', line) for line in list2]      # <remove spurious accuweather filter />
...
list2 = [re.sub(r'^[_\W]?fi[tx][_\W]*$', '', line) for line in list2]           # <remove spurious file fi(t|x) />
