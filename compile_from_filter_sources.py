...
list2 = [re.sub(r'^[_\W]?big[_\W]?\*?$', '', line) for line in list2]               # <remove spurious big filter />
...
list2 = [re.sub(r'^[_\W]?fix[_\W]?\*?$', '', line) for line in list2]               # <remove spurious file fix />
...
list2 = [re.sub(r'^[_\W]?github[_\W]?\*?$', '', line) for line in list2]            # <remove spurious github filter />
...
list2 = [re.sub(r'^[_\W]?market[_\W]?\*?$', '', line) for line in list2]            # <remove spurious market filter />
...
list2 = [re.sub(r'^[_\W]?prod(uction)?[_\W]?\*?$', '', line) for line in list2]     # <remove spurious prod(uction) filter />
...
list2 = [re.sub(r'^[_\W]?raw[_\W]?\*?$', '', line) for line in list2]               # <remove spurious raw filter />
...
list2 = [re.sub(r'^[_\W]?side[_\W]?\*?$', '', line) for line in list2]              # <remove spurious side filter />
...
list3 = [re.sub(r'^\.?github\.com$', '', line) for line in list3]                   # <remove github.com />
...
list3 = [re.sub(r'^\.?microsoft\.com$', '', line) for line in list3]                # <remove microsoft.com />
