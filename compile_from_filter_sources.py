...
list2 = [re.sub(r'^[_\W]?min\.js$', '', line) for line in list2]                            # <remove min.js filter />
list2 = [line for line in list2 if len(line) > 1]                                           # <remove items if length < 2 />
...
list2 = [re.sub(r'^[_\W]?addons?[_\W]?\*?$', '', line) for line in list2]           # <remove spurious addon(s) filter />
...
list2 = [re.sub(r'^[_\W]?(inc?|out)[_\W]?\*?$', '', line) for line in list2]          # <remove spurious (in|out) filter />
...
list3 = [re.sub(r'^\.?blog(spot)?\.(com|net|org|[a-z]{2})$', '', line) for line in list3]     # <remove blogspot.(com|net|org|[a-z]{2}) />
...
list3 = [re.sub(r'^\.?developpers\.google\.com$', '', line) for line in list3]      # <remove developpers.google.com />
...
list3 = [re.sub(r'^\.?weblogssl\.org$', '', line) for line in list3]                # <remove weblogssl.com />
