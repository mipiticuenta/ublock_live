...
list2.append('@@/[_\W]logs?[_\W]/$domain=google.com/maps/_/ss/')
list2.append('@@/\.ttf(?:\W)?/$domain=meteoblue.com')
list2.append('@@​/\.woff2?(?:\W)?/$domain=meteoblue.com')
...
list2.append('*##+js(json-prune, 。「」、・ヲァィゥェォャュョッーアイウエオカキクケコサシスセソタチツテトナニヌネノハヒフヘホマミムメモヤユヨラリルレロワン゛゜)')
...
list2.append('*##+js(json-prune, ヴ____ガ_ギ_グ_ゲ_ゴ_ザ_ジ_ズ_ゼ_ゾ_ダ_ヂ__ヅ_デ_ド______バ__ビ__ブ__ベ__ボ)')
list2.append('*##+js(json-prune, ヴ__ガギグゲゴザジズゼゾダヂヅデド_____バビブベボ)')
list2.append('*##+js(json-prune, ウカキクケコサシスセソタチツテトハヒフヘホ)')
list2.append('*##+js(json-prune, パ__ピ__プ__ペ__ポ)')
list2.append('*##+js(json-prune, ハヒフヘホ)')
list2.append('*##+js(json-prune, パピプペポ)')
