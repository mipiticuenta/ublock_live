...
list3 = [re.sub(r'^\.?morningstar\.com$', '', line) for line in list3]          # <remove morningstar.(com|es) />
list3 = [re.sub(r'^\.?motortrend\.(com|es)$', '', line) for line in list3]      # <remove motortrend.com />
