...
list2 = [re.sub(r'^[_\W]?landing[_\W]*$', '', line) for line in list2]          # <remove spurious landing filter />
...
list3 = [re.sub(r'^\.?accuweather\.com$', '', line) for line in list3]          # <remove accuweather.com />
list3 = [re.sub(r'^\.?afr\.com$', '', line) for line in list3]                  # <remove afr.com />
...
list3 = [re.sub(r'^\.?(rsc\.)?cdn77\.org$', '', line) for line in list3]        # <remove (rsc.)cdn77.org />
...
list3 = [re.sub(r'^\.?diariodecadiz\.es$', '', line) for line in list3]         # <remove diariodecadiz.es />
...
list3 = [re.sub(r'^\.?fox10phoenix\.com$', '', line) for line in list3]         # <remove fox10phoenix.com />
...
list3 = [re.sub(r'^\.?gitlab\.com$', '', line) for line in list3]               # <remove gitlab.com />
...
list3 = [re.sub(r'^\.?howtogeek\.com$', '', line) for line in list3]            # <remove howtogeek.com />
...
list3 = [re.sub(r'^\.?telegraph\.co\.uk$', '', line) for line in list3]         # <remove telegraph.co.uk />
list3 = [re.sub(r'^\.?theguardian\.com$', '', line) for line in list3]          # <remove theguardian.com />
...
list3 = [re.sub(r'^\.?wired\.com$', '', line) for line in list3]                # <remove wired.com />
