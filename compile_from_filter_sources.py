...
list2 = [re.sub(r'^[_\W]?bootstrap[_\W]?\*?$', '', line) for line in list2]         # <remove spurious bootstrap filter />
...
list2 = [re.sub(r'^[_\W]?digitalocean[_\W]?\*?$', '', line) for line in list2]      # <remove spurious digitalocean filter />
...
list2 = [re.sub(r'^[_\W]?input[_\W]?\*?$', '', line) for line in list2]             # <remove spurious input filter />
