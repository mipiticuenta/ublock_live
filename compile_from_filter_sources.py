...
for pattern in tqdm.tqdm(list9) :
    list2 = [re.sub(r'{}'.format(pattern), '', line) for line in list2]         # <remove spurious filter from main list based on regex-white_list/>
    list5 = [re.sub(r'{}'.format(pattern), '', line) for line in list5]                       # <remove spurious filter from regex list based on regex-white_list />
