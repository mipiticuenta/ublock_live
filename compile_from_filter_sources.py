...
while n_1 > len(list2):                                                         # <recursive loops up to no further length reduction for list2 />
    ...
    list2 = [re.sub(r'([^\*])\$.*$(?<!/)(?<!important)', r'\1', line) for line in list2]    # <remove specific trailing $ filters except *$ or ending with important />
    list2 = [re.sub(r'\??\*\=.*(^/)$', '', line).strip() for line in list2]             # <remove trailing ?*=... />
    list2 = [line for line in list2 if len(line) > 1]                                   # <remove items if length < 2 />
    print('       ', '{:,}'.format(len(list2)), 'filters kept')
...
list2 = [re.sub(r'^/base.js$', '', line) for line in list2]                                 # <remove /base.js filter />
...
list2 = [re.sub(r'^\.?blog(spot)?\.(com|net|org|[a-z]{2})$', '', line) for line in list2]     # <remove blogspot.(com|net|org|[a-z]{2}) />
list2 = [re.sub(r'^\.?cdn77\.org$', '', line) for line in list2]                    # <remove cdn77.org />
...
list2 = [re.sub(r'^\.?elmundo\.es$', '', line) for line in list2]                   # <remove elmundo.es />
list2 = [re.sub(r'^\.?europasur\.es$', '', line) for line in list2]                 # <remove europasur.es />
...
list2 = [re.sub(r'^\.?investing\.com$', '', line) for line in list2]                # <remove investing.com />
list2 = [re.sub(r'^\.?ikea\.com$', '', line) for line in list2]                     # <remove ikea.com />
list2 = [re.sub(r'^\.?lemonde\.fr$', '', line) for line in list2]                   # <remove lemonde.fr />
list2 = [re.sub(r'^\.?macworld\.com$', '', line) for line in list2]                 # <remove macworld.com />
list2 = [re.sub(r'^\.?marketbeat\.com$', '', line) for line in list2]               # <remove marketbeat.com />
list2 = [re.sub(r'^\.?meteoblue\.com$', '', line) for line in list2]                # <remove meteoblue.com />
...
list2 = [re.sub(r'^\.?nasdaq\.com$', '', line) for line in list2]                   # <remove nasdaq.com />
list2 = [re.sub(r'^\.?reuters\.com$', '', line) for line in list2]                  # <remove reuters.com />
list2 = [re.sub(r'^\.?rfi\.fr$', '', line) for line in list2]                       # <remove rfi.fr />
...
list2 = [re.sub(r'^\.?ytimg\.com$', '', line) for line in list2]                    # <remove ytimg.com />
list2 = [line for line in list2 if len(line) > 1]                                   # <remove items if length < 2 />
print('       ', '{:,}'.format(len(list2)), 'filters kept')
...
print('removing #.@(.@) (numerical domain) filters and root @.@ domains: ', end = '')
