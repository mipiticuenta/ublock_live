...
list2.append('@@*$inline-script,domain=www.youtube.com')
...
list2.append('@@*$xhr,domain=www.youtube.com')
...
list2.append('@@||googlevideo.com^$xhr,domain=music.youtube.com|youtube.com')
