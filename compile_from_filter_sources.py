...
for i in [1,2]:
    ...
    print(' 3/22 : remove items with $badfilter about: %')
    ...
    print(' 4/22 : keep case for cosmetic filters; apply lower case for the remaining')
    list2 = (
    ...
    print(' 5/22 : keep domains from dns filters; remove items involving IP4/6, localhost')
    ...
    print(' 6/22 : remove leading www. :// :port  http?:// | ||')
    ...
    print(' 7/22 : keep $csp=all')
    list2 = [re.sub(r'.*\$csp=.*', '*$csp=all', line) for line in list2]                 # <ensure *$csp=all'/>

    print(' 8/22 : remove $ filters and ghide exceptions combined with domain=')
    ...
    print(' 9/22 : remove trailing $ all third-party 3p popup image doc')
    ...
    print('12/22 : split urls with $domains=')
    ...
    print('13/22 : simplify urls keeping just last /* part')
    ...
    print('14/22 : replace leading/trailing * ~ , trailing , ,php?')
    list2 = [re.sub(r'^\*\.', '.', line).strip() for line in list2]                      # <replace leading *. with ./ >
    list2 = [re.sub(r'^\*/', '/', line).strip() for line in list2]                       # <replace leading */ with / >
    ...
    print('15/22 : remove /api .png /app /*/ lines ')
    ...
    print('16/22 : remove /wp-content/uploads/.*')
    list2 = [re.sub(r'(?<=\w)/wp\-content/uploads/.*', '', line) for line in list2]      # <remove /wp-content/uploads/.*' />

    print('17/22 : remove trailing .php ; cleanup trailing .js')
    ...
    print('18/22 : replace leading .@/ with /')
    list2 = [re.sub(r'^\.[a-z]/', '/', line) for line in list2]                          # <remove leading .@+/ />

    print('19/22 : generalize cosmetic filters (*##)')
    list2 = [re.sub(r'^.*(?=##)', '*', line) for line in list2]                          # <generalize cosmetic filters (*##) />

    print('20/22 : remove cosmetic filters (##) and exceptions (@@)')
    ...
    print('21/22 : remove key domains (google.com , etc)')
    ...
    print('22/22 : split , separated domains')
