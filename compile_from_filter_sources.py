...
list2 = [re.sub(r'^[_\W]?market(ing)[_\W]?\*?$', '', line) for line in list2]       # <remove spurious market(ing) filter />
...
list3 = [re.sub(r'^\.?europasur\.(es|net)$', '', line) for line in list3]           # <remove europasur.(es|net) />
...
list3 = [re.sub(r'^\.?nytimes\.com$', '', line) for line in list3]                  # <remove nytimes.com />
