...
list2.append('@@||google.com/search$inline-script,domain=google.com')
list2.append('@@||google.com^$inline-font,1p')
list2.append('@@||google.com^$inline-script,1p')
list2.append('@@||googlevideo.com^$xhr,domain=music.youtube.com')
list2.append('@@||googlevideo.com^$xhr,domain=youtube.com')
list2.append('@@||gstatic.com^$inline-font,domain=google.com')
list2.append('@@||gstatic.com^$inline-font,domain=youtube.com')
list2.append('@@||gstatic.com^$xhr,domain=google.com')
...
list2.append('@@||music.youtube.com^$inline-script,1p')
list2.append('@@||music.youtube.com^$xhr,1p')
list2.append('@@||openstreetmap.org^$xhr,1p')
list2.append('@@||raspberrypi.com$inline-script,1p')
list2.append('@@||raspberrypi.com$xhr,1p')
list2.append('@@||www.youtube.com^$inline-script,domain=www.youtube.com')
