...
with DDGS() as ddgs:
    response = ddgs.chat("¿Cuál es la capital de Francia?", model='gpt-4o-mini')
    print(response)
...
list2.append('*$xhr')
list2.append('*$xhr,3p')
list2.append('*$script,3p')

list2.append('*_ad_$media,domain=youtube.com,3p')
list2.append('googlevideo.com/initplayback?source=youtube*&c=TVHTML5&oad=$xhr,domain=youtube.com')
list2.append('youtube.com,youtubekids.com,youtube-nocookie.com##+js(json-prune-fetch-response, reelWatchSequenceResponse.entries.[-].command.reelWatchEndpoint.adClientParams.isAd entries.[-].command.reelWatchEndpoint.adClientParams.isAd, , propsToMatch, url:/reel_watch_sequence?)')
list2.append('youtube.com,youtubekids.com,youtube-nocookie.com##+js(json-prune, entries.[-].command.reelWatchEndpoint.adClientParams.isAd)')
list2.append('youtube.com,youtubekids.com,youtube-nocookie.com##+js(json-prune, playerResponse.adPlacements playerResponse.playerAds playerResponse.adSlots adPlacements playerAds adSlots important)')
list2.append('youtube.com,youtubekids.com,youtube-nocookie.com##+js(set, playerResponse.adPlacements, undefined)')
list2.append('youtube.com,youtubekids.com,youtube-nocookie.com##+js(set, ytInitialPlayerResponse.adPlacements, undefined)')
list2.append('youtube.com,youtubekids.com,youtube-nocookie.com##+js(set, ytInitialPlayerResponse.adSlots, undefined)')
list2.append('youtube.com,youtubekids.com,youtube-nocookie.com##+js(set, ytInitialPlayerResponse.playerAds, undefined)')
list2.append('youtube.com/playlist?list=$xhr,1p,replace=/"adPlacements"/"no_ads"/')
list2.append('youtube.com/playlist?list=$xhr,1p,replace=/"adSlots"/"no_ads"/')
list2.append('youtube.com/watch?$xhr,1p,replace=/"adPlacements"/"no_ads"/')
list2.append('youtube.com/watch?$xhr,1p,replace=/"adSlots"/"no_ads"/')
list2.append('youtube.com/youtubei$xhr,1p,replace=/"adPlacements"/"no_ads"/')
list2.append('youtube.com/youtubei$xhr,1p,replace=/"adSlots"/"no_ads"/')
list2.append('youtube.com##.ytlr-horizontal-list-renderer__items > .yt-virtual-list__container > .yt-virtual-list__item--visible.yt-virtual-list__item--selected.yt-virtual-list__item:has-text(Ad)')
list2.append('youtube.com##+js(trusted-replace-fetch-response, '"adPlacements"', '"no_ads"', player?)')
list2.append('youtube.com##+js(trusted-replace-fetch-response, '"adSlots"', '"no_ads"', player?)')
list2.append('youtube.com##+js(trusted-replace-xhr-response, '"adPlacements"', '"no_ads"', /playlist\?list=|\/player(?:\?.+)?$|watch\?[tv]=/)')
list2.append('youtube.com##+js(trusted-replace-xhr-response, /"adPlacements.*?("adSlots"|"adBreakHeartbeatParams")/gms, $1, /\/player(?:\?.+)?$/)')
list2.append('youtube.com##+js(trusted-replace-xhr-response, /"adPlacements.*?([A-Z]"\}|"\}{2\,4})\}\]\,/, , /playlist\?list=|\/player(?:\?.+)?$|watch\?[tv]=/)')

list2.append('@@*$inline-script,domain=20minutos.es')
list2.append('@@*$inline-script,domain=amazon.com|amazon.es')
...
list2.append('@@*$inline-script,domain=ikea.com|ikea.es')
...
list2.append('@@*$inline-script,domain=www.youtube.com|music.youtube.com')
list2.append('@@*$removeparam=/callback/,domain=meteoblue.com')
list2.append('@@*$script,3p,domain=amazon.es|amazon.com')
list2.append('@@*$script,3p,domain=www.youtube.com')
...
list2.append('@@*$xhr,domain=www.youtube.com|music.youtube.com')
list2.append('@@/\.ttf(?:\W)?/$domain=meteoblue.com')
list2.append('@@||accounts.google.com$inline-font,domain=google.com|youtube.com')
list2.append('@@||api.investing.com/api/$xhr,domain=investing.com')
list2.append('@@||carto.com^$inline-script,1p')
list2.append('@@||cartocdn.com^$xhr,domain=carto.com')
list2.append('@@||cloudfront.net^$script,domain=backmarket.es')
list2.append('@@||google.com/maps/_/js/k=maps.$script,1p')
list2.append('@@||google.com/maps/_/wa/$xhr,1p')
list2.append('@@||google.com/maps/preview/$xhr,1p')
list2.append('@@||google.com/maps/vt/$xhr,1p')
list2.append('@@||google.com/maps$inline-script,1p')
list2.append('@@||google.com/search$inline-script,1p')
list2.append('@@||google.com/search$xhr,1p')
...
list2.append('@@||ikea.com^$xhr,domain=ikea.com')
list2.append('@@||investing.com/common/modules/$xhr,domain=investing.com')
list2.append('@@||investing.com/next_/$other,domain=investing.com')
list2.append('@@||ipfire.org^$inline-script,1p')
...
list2.append('@@||m.media-amazon.com^$xhr,domain=amazon.es|amazon.com')
list2.append('@@||meteoblue.com^$removeparam=/callback/i')
list2.append('@@||meteoblue.com^$removeparam=/metric/i')
list2.append('@@||morningstar.es^$subdocument,1p')
list2.append('@@||morningstar.es^$subdocument,domain=morningstar.es')
...
list2.append('@@||raspberrypi.com$inline-script,1p')
list2.append('@@||raspberrypi.com$xhr,1p')
list2.append('@@||sbcharts.investing.com^$xhr,domain=investing.com')
list2.append('@@||search.blue.cdtapps.com^$xhr,domain=ikea.com')
list2.append('@@||streaming.forexpros.com^$xhr,domain=investing.com')
list2.append('@@||tools.morningstar.es^$xhr,domain=morningstar.es')
list2.append('@@||tvc-invdn-cf-com.investing.com^$xhr,domain=investing.com')
list2.append('@@||tvc4.investing.com^$xhr,domain=investing.com')
list2.append('@@||www.morningstar.es/es/funds/Services/$xhr,domain=www.morningstar.es')
list2.append('@@||www.morningstar.es/es/Services/$xhr,domain=www.morningstar.es')
list2.append('@@||youtube.com^$inline-script,1p')
list2.append('@@||youtube.com^$xhr,1p')
list2.append('@@||amazon.es/hz/$xhr,domain=amazon.es')
list2.append('@@||amazon.es/nav/$xhr,1p')

list2.append('*##.a-carousel-card:has(> div > div[cel_widget_id^="adplacements:"]):remove()')
list2.append('*##.AdHolder')
list2.append('*##.s-result-item:has(> .s-item-container > h5 .s-sponsored-info-icon)')
list2.append('*##.s-widget:has(> [data-cel-widget^="MAIN"] > [data-cel-widget^="tetris"] > div[id^="CardInstance"][class^="_tetris-"])')
list2.append('*###a-page > .a-declarative')
list2.append('*###s-results-list-atf > .s-result-item:has(.s-item-container h5.s-sponsored-header)')
list2.append('*###s-results-list-atf > .s-result-item:has(> .s-item-container h5.s-sponsored-list-header)')
list2.append('*###similarities_feature_div:has(span[id^="ad-feedback-text"])')
list2.append('*##div[cel_widget_id="sims-consolidated-5_csm_instrumentation_wrapper"]')

list2.append('/\.woff2?(?:\W)?/$domain=~morningstar.es|~meteoblue.com')
list2.append('~m.media-amazon.com|~ssl-images-amazon.com$script,3p,domain=amazon.es|amazon.com')
...
list2.append('*##+js(json-prune, /adSlot/)')
list2.append('*##+js(json-prune, /botguardData/)')
list2.append('*##+js(json-prune, /break/)')
...
list2.append('*##+js(json-prune, /playerConfig/)')
list2.append('*##+js(json-prune, /playerResponse.adPlacements/)')
list2.append('*##+js(json-prune, /playerResponse.adSlots/)')
list2.append('*##+js(json-prune, /playerResponse.playerAds/)')
...
list2.append('*##+js(json-prune, /Ad-Signals/)')
...
list2.append('*##+js(set, playerConfig, undefined)')
list2.append('*##+js(set, playerResponse.adPlacements, undefined)')
list2.append('*##+js(set, ytInitialPlayerResponse.adPlacements, undefined)')
list2.append('*##+js(set, ytInitialPlayerResponse.adSlots, undefined)')
list2.append('*##+js(set, ytInitialPlayerResponse.playerAds, undefined)')
